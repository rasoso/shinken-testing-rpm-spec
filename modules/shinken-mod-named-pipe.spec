%global commit 8a730e7f6a776b76f9da2fe32a4427eb899fa1c8
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  named-pipe
...
Summary:        Shinken module for listening external commands from a Unix named pipe (like Nagios)
License:        AGPL

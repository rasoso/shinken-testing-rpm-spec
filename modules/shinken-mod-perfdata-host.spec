%global commit 03578861f9751354755c8610380f4f4fb5fc5a4e
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  perfdata-host
...
Summary:        Shinken module for exporting host data to a flat file (Centreon compatibility)
License:        AGPL

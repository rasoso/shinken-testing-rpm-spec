%global commit 1c37662ca04f78bfb7537a93438f269e0f7e8121
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  auth-active-directory
...
Summary:        Shinken module for UI authentification with Active Directory or OpenLDAP
License:        AGPL

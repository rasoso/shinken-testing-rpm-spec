%global commit fc5499f608740787bdb14588afb77dcae83461e1
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  retention-redis
...
Summary:        Shinken module for saving retention data from schedulers to a redis server
License:        AGPL

%global commit 8ba134a5e2649216f6bb0df2ca27b4b15e1ed981
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  pickle-retention-file-generic
...
Summary:        Shinken module for saving retention data from Arbiter/Broker to a flat file. Use with care.
License:        AGPL

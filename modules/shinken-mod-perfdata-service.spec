%global commit bd660ab4686d45d9d505eb96af2ae34a053d35db
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  perfdata-service
...
Summary:        Shinken module for exporting services data to a flat file (Centreon compatibility)
License:        AGPL

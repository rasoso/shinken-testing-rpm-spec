%global commit b4c825c4af19c5605bfe41aaad558c408c0d2b81
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  auth-htpasswd
...
Summary:        Shinken module for UI authentication from Apache passwd files 
License:        AGPL

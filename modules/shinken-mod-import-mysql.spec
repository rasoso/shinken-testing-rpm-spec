%global commit 6e6ed9cfd237765e9ebbf2ae706aa40c52119933
...
Summary:        Shinken module for importing configurations from a MySQL server
License:        AGPL
...
%description
This broker module is made to import configurations to Shinken from a
MySQL database. All configurations read from the database will be
added to those read from the standard flat files.
But be carefull of duplicated names!
You can easily use an existing database, you just have to define the
queries to suit your database.

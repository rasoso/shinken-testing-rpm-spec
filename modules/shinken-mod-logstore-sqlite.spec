%global commit 9d53dff1a22fadbeb64be77ecd7fbe705c186ea9
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  logstore-sqlite
...
Summary:        shinken module logstore sqlite
License:        AGPL
URL:            https://github.com/%{repo}/mod-%{module}
Source0:        https://github.com/%{repo}/mod-logstore-sqlite/archive/%{commit}.tar.gz#/%{name}-%{version}-%{commit}.tar.gz

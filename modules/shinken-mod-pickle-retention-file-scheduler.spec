%global commit e0e70590e842c61aa416eb6140c50f9287761b8f
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  pickle-retention-file-scheduler
...
Summary:        Shinken module for saving retention data from schedulers to a flat file.
License:        AGPL

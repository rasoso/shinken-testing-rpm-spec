%global commit f324205bb709ff8d929a43d78b8bec700d155495
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  hot-dependencies
...
Summary:        Shinken module for automatically create dependencies between hosts, based on a command/file.
...
%description
Shinken module for automatically create dependencies between hosts,
based on a command/file. Like for creating links between VMWare ESX
and VMs with VMotion management.

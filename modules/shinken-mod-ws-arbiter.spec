%global commit 022674381db91b5dc33101f855c411bc9f710fe8
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  ws-arbiter
...
Summary:        Shinken module for listening external commands from a web service
License:        AGPL
...
%description
The ws-arbiter module is an Arbiter (or Receiver) module to treat
requests from remote hosts via HTTP(s).

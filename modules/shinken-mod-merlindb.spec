%global commit ce53a13076022c3c092e44432a7f98f35f56b7ea
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  merlindb
...
Summary:        Shinken module for exporting data to a OP5/Merlin database (Mysql or sqlite)
License:        AGPL

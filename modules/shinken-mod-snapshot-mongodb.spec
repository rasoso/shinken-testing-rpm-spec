%global commit 291cf78839bc9f1ad51f5a3d348d5bded4611ef4
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  snapshot-mongodb
%global repo naparuba
%global json_version 1.0

Name:           shinken-mod-%{module}
Version:        %{json_version}
Release:        %{checkout}%{?dist}
Summary:        Shinken module (broker) to save into mongodb the snapshots of hosts and services
License:        AGPL
...
%description
Shinken module (broker) to save into mongodb the snapshots of hosts
and services.
Snapshots are used on hosts and services to dump a state of an host or
a service when there is an error, like dumping processes when your
load is too high

%global commit 6079d31974305b74e332424df44efecc9dfeabfc
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  auth-cfg-password
%global repo shinken-monitoring
%global json_version 2.0.1

Name:           shinken-mod-%{module}
Version:        %{json_version}
Release:        %{checkout}%{?dist}
Summary:        Shinken module for UI authentification from simple password for configuration file
License:        AGPL

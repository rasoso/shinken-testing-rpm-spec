%global commit 82ea3ca47e6dad979025909e85c44c91d19a2a59
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  simple-log
...
Summary:        Shinken module for exporting all logs into a common flat file.
License:        AGPL
...
%description
Shinken module for exporting all logs into a common flat file.

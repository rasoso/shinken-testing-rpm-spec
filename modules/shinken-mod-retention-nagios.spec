%global commit a9e021193b92ec03ae7cd1d7aa6b230da760cc11
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  retention-nagios
...
Summary:        Shinken module for loading Nagios retention data. Load only (no write). For migration.
License:        AGPL

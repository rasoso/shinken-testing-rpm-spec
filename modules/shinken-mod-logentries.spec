%global commit 55c39adc42f8ead83ce05de3eb748f51f3c605ae
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  logentries
%global repo StephenHynes7
%global json_version 1.0

Name:           shinken-mod-%{module}
Version:        %{json_version}
Release:        %{checkout}%{?dist}
Summary:        Shinken module for sending log data to logentries.com 
License:        AGPL
...
%description
Shinken module for sending log data to logentries.com 

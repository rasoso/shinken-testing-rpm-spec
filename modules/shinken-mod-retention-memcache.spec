%global commit c29378d6b2494d1df907776914e879790c07f42e
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  retention-memcache
...
Summary:        Shinken module for saving retention data from schedulers to a memcache server
License:        AGPL

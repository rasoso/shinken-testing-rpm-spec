%global commit 48e5a03adefef57ee4ca28b41dff3997c54d3697
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  status-dat
...
Summary:        Shinken module for exporting data to a Nagios status.dat comptabile format
License:        AGPL

%global commit af1d71dbfc311058ad60804023646c19ba464109
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  auth-pam
%global repo mingbowan
%global json_version 0.1

Name:           shinken-mod-%{module}
Version:        %{json_version}
Release:        %{checkout}%{?dist}
Summary:        Shinken module for pam authentication for shinken webui 
License:        AGPL
...
%description
Shinken module for pam authentication for shinken webui 

%global commit a40699a03a80d61fd4b6b844f769cdc05cb126d3
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  import-aws
...
Summary:        Shinken module for importing hosts from Amazon EC2 (AWS)
License:        AGPL
...
%description
Shinken module for importing hosts from Amazon EC2 (AWS)

You can import data from Amazon AWS/EC2 AWS into Shinken to create
hosts.  Amazon provide VM hosting with EC2. With this arbiter module,
you will be able to load your EC2 hosts into Shinken.

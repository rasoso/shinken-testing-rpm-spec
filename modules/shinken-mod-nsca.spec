...
Summary:        Shinken module for listening external commands from a NSCA like daemon
License:        AGPL
...
%description
Shinken module for listening external commands from a NSCA like daemon

The NSCA daemon module is used to receive NSCA packets and submit them
to the Shinken command pipe. The NSCA module can be loaded by the
Receiver (best solution) or Arbiter process. It will listen on port
TCP/5667 for NSCA packets.

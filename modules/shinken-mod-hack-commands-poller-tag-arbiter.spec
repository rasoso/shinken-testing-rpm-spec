%global commit 4224b8a384836786373002c09c0c82d1aa5e5148
%global shortcommit %(c=%{commit}; echo ${c:0:7})
%global date %(date +%%Y%%m%%d)
%global checkout %{date}git%{shortcommit}
%global module  hack-commands-poller-tag-arbiter
...
Summary:        Shinken module for tagging commands with pollerts tags based on their names
License:        AGPL

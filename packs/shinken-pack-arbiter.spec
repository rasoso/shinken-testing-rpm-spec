...
Summary:        Shinken configuration pack for checking Shinken daemons health
License:        AGPL
...
%description
Shinken configuration pack for checking Shinken daemons health

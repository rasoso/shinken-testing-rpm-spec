...
Summary:        Shinken configuration pack for IBM Storwize Vxxxx You must install Standard Based Linux Instrumentation package: sblim-wbemcli
License:        AGPL
...
%description
Configuration pack for IBM xSeries server. Copy/paste
ipmi.conf.example in plugins directory as ipmi.conf and modify it to
fit your ipmi settings
